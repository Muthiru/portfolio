...
export const projects: Project[] = [
  ...
  {
    name: 'Java-class',
    description: 'Abstract class implementation in Java.',
    language: 'Java',
    repoUrl: 'https://github.com/Muthiru/Java-class',
    tags: ['java'],
    updatedAt: '2025-06-12',
  },
  {
    name: 'Abstract-class',
    description: 'Abstract class implementation.',
    language: 'Java',
    repoUrl: 'https://github.com/Muthiru/Abstract-class',
    tags: ['java'],
    updatedAt: '2025-02-01',
  },
  {
    name: 'TravelPackage-Class',
    description: 'Java class project for travel package modelling.',
    language: 'Java',
    repoUrl: 'https://github.com/Muthiru/TravelPackage-Class',
    tags: ['java'],
