      ...
      <div className="about-grid">
        <div>
          <div className="about-text">
            <p>
              I completed my BSc in Computer Science at John Paul II Catholic University of Lublin. Alongside my degree, I was shipping production work as a full-stack developer at PRIOT Digital Systems - SaaS workflows, API integrations, billing, and document automation.
            </p>
            <p>
